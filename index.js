...
const UUID = process.env.UUID || '4990498d-1463-4d02-92e8-8e3add27f972'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nazha.xccssaa.dpdns.org';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '443';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'f3aba8ff-4e77-495e-bb2d-142e28845a75';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
